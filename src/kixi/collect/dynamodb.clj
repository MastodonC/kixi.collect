...
(defn get-item-skeptical
  ([conn table id-column id]
   (get-item-skeptical conn table id-column id nil))
  ([conn table id-column id options]
   (try
     (get-item conn table id-column id options)
     (catch com.amazonaws.services.dynamodbv2.model.ResourceNotFoundException e nil))))
